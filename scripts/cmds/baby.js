...
module.exports.onStart = async ({ api, event, args, usersData }) => {
  ...
  try {
    if (!args[0]) {
      const ran = ["কি হয়েছে বারা দই খাবে নাকি?😡", "I love you", "type !bby hi"];
  ...
  try {
    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          "babu khuda lagse🥺",
          "Mihan এর পুটকি মারতে চাই",
          "সামির শুওর টাকে একটু ডাক দাও",
          "এই বাদ দিয়ে বলো জিসান বেশ্যা কোথায় গেছে? গাজা খেতে?",
          "জহির কে সিনালের মতো লাগে জানো তোমরা?",
          "মুগ্ধ সৌরাচার শালা কুত্তা",
          "Hop beda😾,বউ বল বউ😼",  
          "আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘 ",  
          "🐒🐒🐒",
          "bye",
          "amr বাবুর আতিফের মুখে কন্ডম ঢুকিয়ে দাও",
          "mb ney bye",
          "meww",
          ...
          "চৌধুরী সাহMahMU গরিব হতে পারি😾🤭 -কMahMUিন্তু বড়লোক না🥹 😫",
          "আমি অন্যের জিনিসের সাথে কথা বলি না__😏ওকে",
          "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
          "ভুলে জাও আমাকে 😞😞",
          "দেখাMahকাঠগোলাপ..🤗",
          ...
          "বুক চিনচিন করছে হায় মন সামিরকে চুদতে চায়🥵",
          "তোমরা কি জানো লামিম বিরি লুকাই লুকাই খায়😪",
          "পড়তে বসেক নাহলে ফেল করবি😴",
          "তোদের কালে আমি চাদের আলোতে পরতে বসলাম😗",
          "মুগ্ধ কি আসলেই সৌরাচার?🤔",
          "আকাশ ভড়া তারা জহিরের পু*কি মারা সারা!🤤😶"
        ];
